...
def main():
    ...
    # 提现拒绝/取消按钮
    app_tg.add_handler(CallbackQueryHandler(handle_payment_callback, pattern=r'^(reject|cancel)_withdraw_'))
